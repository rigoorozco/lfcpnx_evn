...
EVAL_IP=True
FIRMWARE_PATH=$(abspath firmware/test)

%.rdf: sources.tcl
	@echo "Creating project: $(PROJECT_NAME)..."
	$(RADIANT_PREFIX)/radiantc scripts/create_project.tcl $(PROJECT_NAME) $(EVAL_IP) $(FIRMWARE_PATH)
...
clean:
	rm -rf $(PROJECT_NAME)
	rm -f radiantc.log* radiantc.tcl*
