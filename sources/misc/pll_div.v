...
module pll_div (clki_i, 
    ...
    output clkop_o ; 
    output lock_o ; 
    pll_div_ipgen_lscc_pll #(.INTFBKDEL_SEL("DISABLED"),
...
// Module : lscc_pll
//==========================================================================
module pll_div_ipgen_lscc_pll #(parameter FVCO = 800.0, 
    ...
    generate
        if ((APB_EN == 1)) 
            begin : APB2LMMI_INST
                ...
                ///
                pll_div_ipgen_lscc_apb2lmmi #(.DATA_WIDTH(8),
                        .ADDR_WIDTH(7),
...
//==========================================================================
module pll_div_ipgen_lscc_apb2lmmi #(parameter DATA_WIDTH = 32, 
